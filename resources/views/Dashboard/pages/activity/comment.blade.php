    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="card text-center">
                <div class="body">
                    <p class="m-b-20"><i class="zmdi zmdi-balance zmdi-hc-3x col-amber"></i></p>
                    <span>عدد تعليقات الموقع</span>
                    <h3 class="m-b-10"><span class="number count-to" data-from="0" data-to="{{ App\models\comments::count() }}" data-speed="2000" data-fresh-interval="700"></span></h3>
                    <small class="text-muted">جميع التعليقات المفعلة و غير مفعلة</small>
                </div>
            </div>
        </div>
    </div>
